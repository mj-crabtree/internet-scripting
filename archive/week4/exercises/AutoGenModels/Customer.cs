...
namespace exercises
{
    ...
    public class Customer
    {
        ...
        [Column(TypeName = "nvarchar (30)")] public string ContactName { get; set; }
        [Column(TypeName = "nvarchar (30)")] public string ContactTitle { get; set; }
        ...
        [Column(TypeName = "nvarchar (24)")] public string Fax { get; set; }
    }
}
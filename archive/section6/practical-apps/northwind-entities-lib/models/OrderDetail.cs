...
namespace Matt.Shared
{
    ...
    {
        [Key] [Column(TypeName = "int")] public long OrderID { get; set; }
        ...
        [Column(TypeName = "smallint")] public long Quantity { get; set; }

        [Column(TypeName = "real")] public double Discount { get; set; }
